function [ omega_1, theta_1, phi_1] = psoOmega_1(u, IR_3, tau)
%function [objective_value, omega_1, theta_1] = psoOmega_1(u, IR_3, tau)
...
omega_1 = [cos(global_best_position(1)) * sin(global_best_position(2)),
