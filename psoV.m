...
random_personal_best = rand(num_particles, 1) .* (personal_best_positions - particle_positions);
    ...
    % Cap nhat Vi tri Ca nhan tot nhat
    ...
    % Kiem tra su chenh lech giua global_best_objective hien tai va truoc do
    ...
    % Neu su chenh lech nho hon hoac bang 10^(-12) trong 50 vong lap tiep theo thi dung lai
    if count >= 50
        break;
    end
end
