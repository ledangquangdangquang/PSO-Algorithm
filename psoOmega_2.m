function [ omega_2, theta_2, phi_2] = psoOmega_2(u, IR_4, tau)
%function [objective_value, omega_2, theta_2] = psoOmega_2(u, IR_4, tau)
rng(0);
...
theta_2 = global_best_position(2);
phi_2 = global_best_position(1);
objective_value = global_best_objective;
omega_2 = [cos(global_best_position(1)) * sin(global_best_position(2)),
sin(global_best_position(1)) * sin(global_best_position(2))];
